 ...
 * {@link com.andreavendrame.ldb4docker.myjlibbig.Match}. Furthermore, the redex R is the
 * juxtaposition of F and a suitable identity; these are called the redex image
 * and the redex id respectively.
 */
public class Match extends com.andreavendrame.ldb4docker.myjlibbig.AbstractMatch<Bigraph> {
